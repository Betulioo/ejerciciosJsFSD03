...
// //funcion normal
// async function pintaCharacters2() {
//       const misPersonajes = await getCharacters();
//   //   console.log(misPersonajes.results);
//   for (const personaje of misPersonajes.results) {
//     const h2$$ = document.createElement("h2");
//     h2$$.textContent = personaje.name;
//     const img$$ = document.createElement("img");
//     img$$.setAttribute("src", personaje.image);
...
//   }
// }
const pintaCharacters = async (misPersonajes) => {
  for (const personaje of misPersonajes) {
    const h2$$ = document.createElement("h2");
    h2$$.textContent = personaje.name;
    const img$$ = document.createElement("img");
...
const inicializar = async () => {
  ...
  pintaCharacters(misPersonajesArray);
};
inicializar();
